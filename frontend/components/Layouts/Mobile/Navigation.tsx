import { ChatBubbleOvalLeftEllipsisIcon, DocumentPlusIcon, HomeIcon, PlusCircleIcon, UserCircleIcon } from '@heroicons/react/24/outline'
...
const Navigation = () => {
  return (
    ...
    fixed bottom-0 py-1 space-x-8 md:hidden text-gray-500 border-t border-gray-200 shadow-md bg-white">
      ...
      <Link href="/" className='bg-slate-50 p-2 rounded-full'><DocumentPlusIcon className='h-6 w-6' /> </Link>
      ...
      <Link href="/mypage" className='bg-slate-50 p-2 rounded-full'><UserCircleIcon className='h-6 w-6' /> </Link>
</div>
  )
}
